...
#pragma config(Sensor, in2,    DialPot,        sensorPotentiometer)
...
#pragma config(Motor,  port1,           rightarmbottom, tmotorVex393_HBridge, openLoop)
#pragma config(Motor,  port2,           rightfrontdrive, tmotorServoContinuousRotation, openLoop, reversed)
#pragma config(Motor,  port4,           rightbackdrive, tmotorServoContinuousRotation, openLoop, reversed)
#pragma config(Motor,  port5,           armfront,      tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port7,           leftbackdrive, tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port8,           leftfrontdrive, tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port10,          leftarmbottom, tmotorVex393_HBridge, openLoop)
...
void Sounds()
{
playSoundFile("EstablishingLiwav");
wait1Msec(2500);
...
task HoldArms()
{
	...
	while(SensorValue[Pot1] > 2000 && held == false)
	{
